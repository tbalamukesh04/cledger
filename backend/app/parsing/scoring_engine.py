...
class FeatureExtractor:
    ...
    CURRENCY_PATTERN = re.compile(
        r'\b(?:ZMW|ZMK|USD|EUR|GBP|kwacha|dollars?)\b'
        r'|\$|£|€'
        r'|\b\d+K\b'
        r'|\bK\d+\b',  
        re.IGNORECASE
    ...
    DATE_PATTERN = re.compile(
        r'\b(?:today|yesterday|tomorrow|january|february|march|april|may|june|'
    ...
    VERB_PATTERN = re.compile(
        r'\b(?:paid|sent|received|got|gave|spent|bought|transfer|transferred|'
        r'credit|debit|deposit|withdraw|repay|refund)\b',
        re.IGNORECASE
    )
    ...
    def extract_positive_signals(cls, text: str) -> dict:
        if not text:
            return {
                ...
                "date_detected":             False,
                "transaction_verb_detected": False,
            }
